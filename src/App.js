...
import './App.css'
import ListalivrosLendo from './ListaLivrosLendo'
import ListaLivrosQueroLer from './ListaLivrosQueroLer'
import ListaLivrosLido from './ListaLivrosLido'
            ...
            {this.state.showSearchPage ? (
              ...
              <div className="list-books">
                ...
                <div className="list-books-content">
                  <div>
                      <ListalivrosLendo livrosLendo={this.state.livrosLendo} />
                  </div>
                  <div>
                      <ListaLivrosQueroLer livrosQueroLer={this.state.livrosQueroLer} />
                  </div>
                  <div>
                      <ListaLivrosLido livrosLido={this.state.livrosLido} />
                  </div>
                </div>
                <div className="open-search">
                  <button onClick={() => this.setState({ showSearchPage: true })}>Adicionar um livro</button>
                </div>
              </div>
            )}
        </div>
